...
if st.session_state.step == 0:
    ...
    st.markdown('<section class="diet-preview" id="diet"><div style="text-align:center;margin-bottom:80px;"><div class="section-tag">Ornek Menu</div><h2 class="section-title">Bugun Ne Yiyebilirsin?</h2><p class="section-desc">Sana ozel hazirlanan lezzetli ve dengeli diyet listesi</p></div><div class="diet-card"><div class="diet-header"><span class="diet-day">Pazartesi</span><span class="diet-cal">1370 kcal</span></div><div class="meal-item"><div class="meal-info"><h4>Kahvalti</h4><p>Yulaf ezmesi + Meyve + Bal</p></div><div class="meal-macros"><span>350 kcal</span><span>12g P</span><span>55g K</span></div></div><div class="meal-item"><div class="meal-info"><h4>Ogle</h4><p>Izgara tavuk + Salata</p></div><div class="meal-macros"><span>450 kcal</span><span>38g P</span><span>15g K</span></div></div><div class="meal-item"><div class="meal-info"><h4>Aksam</h4><p>Firin da somon + Sebze</p></div><div class="meal-macros"><span>420 kcal</span><span>32g P</span><span>18g K</span></div></div><div class="meal-item" style="border:none;"><div class="meal-info"><h4>Atistirmalik</h4><p>Bir avuc badem</p></div><div class="meal-macros"><span>150 kcal</span><span>5g P</span><span>8g K</span></div></div></div></section>', unsafe_allow_html=True)
...
# === ANA UYGULAMA (step=4) ===
    ...
    if st.session_state.diet_plan:
        ...
        if selected_day in st.session_state.diet_plan:
            ...
            meal_names = ["Kahvalti", "Ogle", "Aksam", "Atistirmalik"]
